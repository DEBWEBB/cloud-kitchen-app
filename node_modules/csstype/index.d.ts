...
export interface StandardLonghandProperties<TLength = (string & {}) | 0, TTime = string & {}> {
  ...
  /**
   * The **`ma***REMOVED***border-mode`** CSS property specifies the blending mode used in a mask border.
   *
  ...
  /**
   * The **`ma***REMOVED***border-outset`** CSS property specifies the distance by which an element's mask border is set out from its border box.
   *
   * **Syntax**: `[ <length> | <number> ]{1,4}`
   *
   * **Initial value**: `0`
   ...
   * |                 Chrome                  | Firefox |                Safari                 | Edge | IE  |
   * | :-------------------------------------: | :-----: | :-----------------------------------: | :--: | :-: |
   * | **1** _(-webkit-ma***REMOVED***box-image-outset)_ |   No    |               **17.2**                | n/a  | No  |
   * |                                         |         | 3.1 _(-webkit-ma***REMOVED***box-image-outset)_ |      |     |
   *
   * @see https://developer.mozilla.org/docs/Web/CSS/ma***REMOVED***border-outset
   */
  maskBorderOutset?: Property.MaskBorderOutset<TLength> | undefined;
  /**
   * The **`ma***REMOVED***border-repeat`** CSS property sets how the edge regions of a source image are adjusted to fit the dimensions of an element's mask border.
   *
   * **Syntax**: `[ stretch | repeat | round | space ]{1,2}`
   *
   * **Initial value**: `stretch`
   ...
   * |                 Chrome                  | Firefox |                Safari                 | Edge | IE  |
   * | :-------------------------------------: | :-----: | :-----------------------------------: | :--: | :-: |
   * | **1** _(-webkit-ma***REMOVED***box-image-repeat)_ |   No    |               **17.2**                | n/a  | No  |
   * |                                         |         | 3.1 _(-webkit-ma***REMOVED***box-image-repeat)_ |      |     |
   *
   * @see https://developer.mozilla.org/docs/Web/CSS/ma***REMOVED***border-repeat
   */
  maskBorderRepeat?: Property.MaskBorderRepeat | undefined;
  /**
   * The **`ma***REMOVED***border-slice`** CSS property divides the image set by `ma***REMOVED***border-source` into regions. These regions are used to form the components of an element's mask border.
   *
   * **Syntax**: `<number-percentage>{1,4} fill?`
   *
   * **Initial value**: `0`
   ...
   * |                 Chrome                 | Firefox |                Safari                | Edge | IE  |
   * | :------------------------------------: | :-----: | :----------------------------------: | :--: | :-: |
   * | **1** _(-webkit-ma***REMOVED***box-image-slice)_ |   No    |               **17.2**               | n/a  | No  |
   * |                                        |         | 3.1 _(-webkit-ma***REMOVED***box-image-slice)_ |      |     |
   *
   * @see https://developer.mozilla.org/docs/Web/CSS/ma***REMOVED***border-slice
   */
  maskBorderSlice?: Property.MaskBorderSlice | undefined;
  /**
   * The **`ma***REMOVED***border-source`** CSS property sets the source image used to create an element's mask border.
   *
   * **Syntax**: `none | <image>`
   *
   * **Initial value**: `none`
   ...
   * |                 Chrome                  | Firefox |                Safari                 | Edge | IE  |
   * | :-------------------------------------: | :-----: | :-----------------------------------: | :--: | :-: |
   * | **1** _(-webkit-ma***REMOVED***box-image-source)_ |   No    |               **17.2**                | n/a  | No  |
   * |                                         |         | 3.1 _(-webkit-ma***REMOVED***box-image-source)_ |      |     |
   *
   * @see https://developer.mozilla.org/docs/Web/CSS/ma***REMOVED***border-source
   */
  maskBorderSource?: Property.MaskBorderSource | undefined;
  /**
   * The **`ma***REMOVED***border-width`** CSS property sets the width of an element's mask border.
   *
   * **Syntax**: `[ <length-percentage> | <number> | auto ]{1,4}`
   *
   * **Initial value**: `auto`
   ...
   * |                 Chrome                 | Firefox |                Safari                | Edge | IE  |
   * | :------------------------------------: | :-----: | :----------------------------------: | :--: | :-: |
   * | **1** _(-webkit-ma***REMOVED***box-image-width)_ |   No    |               **17.2**               | n/a  | No  |
   * |                                        |         | 3.1 _(-webkit-ma***REMOVED***box-image-width)_ |      |     |
   *
   * @see https://developer.mozilla.org/docs/Web/CSS/ma***REMOVED***border-width
   */
  maskBorderWidth?: Property.MaskBorderWidth<TLength> | undefined;
  /**
   * The **`ma***REMOVED***clip`** CSS property determines the area which is affected by a mask. The painted content of an element must be restricted to this area.
   *
   ...
   * | 1 _-x-_ |         | 4 _-x-_  |      |     |
   *
   * @see https://developer.mozilla.org/docs/Web/CSS/ma***REMOVED***clip
   */
  maskClip?: Property.MaskClip | undefined;
  /**
   * The **`ma***REMOVED***composite`** CSS property represents a compositing operation used on the current mask layer with the mask layers below it.
   *
   ...
   *
   * @see https://developer.mozilla.org/docs/Web/CSS/ma***REMOVED***composite
   */
  maskComposite?: Property.MaskComposite | undefined;
  /**
   * The **`ma***REMOVED***image`** CSS property sets the image that is used as mask layer for an element. By default this means the alpha channel of the mask image will be multiplied with the alpha channel of the element. This can be controlled with the `ma***REMOVED***mode` property.
   *
   * **Syntax**: `<ma***REMOVED***reference>#`
   *
   * **Initial value**: `none`
   *
   * | Chrome  | Firefox |  Safari  | Edge  | IE  |
   ...
   * | 1 _-x-_ |         | 4 _-x-_  |       |     |
   *
   * @see https://developer.mozilla.org/docs/Web/CSS/ma***REMOVED***image
   */
  maskImage?: Property.MaskImage | undefined;
  /**
   * The **`ma***REMOVED***mode`** CSS property sets whether the mask reference defined by `ma***REMOVED***image` is treated as a luminance or alpha mask.
   *
   * **Syntax**: `<masking-mode>#`
   *
   ...
   * | **120** | **53**  | **15.4** | n/a  | No  |
   *
   * @see https://developer.mozilla.org/docs/Web/CSS/ma***REMOVED***mode
   */
  maskMode?: Property.MaskMode | undefined;
  /**
   * The **`ma***REMOVED***origin`** CSS property sets the origin of a mask.
   *
   * **Syntax**: `<geometry-box>#`
   *
   * **Initial value**: `border-box`
   ...
   * | 1 _-x-_ |         | 4 _-x-_  |      |     |
   *
   * @see https://developer.mozilla.org/docs/Web/CSS/ma***REMOVED***origin
   */
  maskOrigin?: Property.MaskOrigin | undefined;
  /**
   * The **`ma***REMOVED***position`** CSS property sets the initial position, relative to the mask position layer set by `ma***REMOVED***origin`, for each defined mask image.
   *
   * **Syntax**: `<position>#`
   *
   ...
   * | 1 _-x-_ |         | 3.1 _-x-_ |       |     |
   *
   * @see https://developer.mozilla.org/docs/Web/CSS/ma***REMOVED***position
   */
  maskPosition?: Property.MaskPosition<TLength> | undefined;
  /**
   * The **`ma***REMOVED***repeat`** CSS property sets how mask images are repeated. A mask image can be repeated along the horizontal axis, the vertical axis, both axes, or not repeated at all.
   *
   * **Syntax**: `<repeat-style>#`
   *
   * **Initial value**: `repeat`
   ...
   * | 1 _-x-_ |         | 3.1 _-x-_ |       |     |
   *
   * @see https://developer.mozilla.org/docs/Web/CSS/ma***REMOVED***repeat
   */
  maskRepeat?: Property.MaskRepeat | undefined;
  /**
   * The **`ma***REMOVED***size`** CSS property specifies the sizes of the mask images. The size of the image can be fully or partially constrained in order to preserve its intrinsic ratio.
   *
   * **Syntax**: `<bg-size>#`
   *
   * **Initial value**: `auto`
   ...
   * | 4 _-x-_ |         | 4 _-x-_  |       |     |
   *
   * @see https://developer.mozilla.org/docs/Web/CSS/ma***REMOVED***size
   */
  maskSize?: Property.MaskSize<TLength> | undefined;
  /**
   * The **`ma***REMOVED***type`** CSS property sets whether an SVG `<mask>` element is used as a _luminance_ or an _alpha_ mask. It applies to the `<mask>` element itself.
   *
   * **Syntax**: `luminance | alpha`
   *
   ...
   * | **24** | **35**  | **7**  | n/a  | No  |
   *
   * @see https://developer.mozilla.org/docs/Web/CSS/ma***REMOVED***type
   */
...
export interface StandardShorthandProperties<TLength = (string & {}) | 0, TTime = string & {}> {
  ...
  /**
   * The **`ma***REMOVED***border`** CSS shorthand property lets you create a mask along the edge of an element's border.
   *
   * **Syntax**: `<'ma***REMOVED***border-source'> || <'ma***REMOVED***border-slice'> [ / <'ma***REMOVED***border-width'>? [ / <'ma***REMOVED***border-outset'> ]? ]? || <'ma***REMOVED***border-repeat'> || <'ma***REMOVED***border-mode'>`
   *
   * |              Chrome              | Firefox |             Safari             | Edge | IE  |
   * | :------------------------------: | :-----: | :----------------------------: | :--: | :-: |
   * | **1** _(-webkit-ma***REMOVED***box-image)_ |   No    |            **17.2**            | n/a  | No  |
   * |                                  |         | 3.1 _(-webkit-ma***REMOVED***box-image)_ |      |     |
   *
   * @see https://developer.mozilla.org/docs/Web/CSS/ma***REMOVED***border
   */
...
export interface VendorLonghandProperties<TLength = (string & {}) | 0, TTime = string & {}> {
  ...
  /**
   * If a `ma***REMOVED***image` is specified, `-webkit-ma***REMOVED***attachment` determines whether the mask image's position is fixed within the viewport, or scrolls along with its containing block.
   *
   * **Syntax**: `<attachment>#`
   *
   * **Initial value**: `scroll`
  ...
  /**
   * The **`-webkit-ma***REMOVED***composite`** property specifies the manner in which multiple mask images applied to the same element are composited with one another. Mask images are composited in the opposite order that they are declared with the `-webkit-ma***REMOVED***image` property.
   *
  ...
  /**
   * The `-webkit-ma***REMOVED***position-x` CSS property sets the initial horizontal position of a mask image.
   *
  ...
  /**
   * The `-webkit-ma***REMOVED***position-y` CSS property sets the initial vertical position of a mask image.
   *
  ...
  /**
   * The `-webkit-ma***REMOVED***repeat-x` property specifies whether and how a mask image is repeated (tiled) horizontally.
   *
  ...
  /**
   * The `-webkit-ma***REMOVED***repeat-y` property sets whether and how a mask image is repeated (tiled) vertically.
   *
   * **Syntax**: `repeat | no-repeat | space | round`
   *
   * **Initial value**: `repeat`
...
export interface VendorShorthandProperties<TLength = (string & {}) | 0, TTime = string & {}> {
   ...
   * The **`mask`** CSS shorthand property hides an element (partially or fully) by masking or clipping the image at specific points.
   *
   * **Syntax**: `[ <ma***REMOVED***reference> || <position> [ / <bg-size> ]? || <repeat-style> || [ <box> | border | padding | content | text ] || [ <box> | border | padding | content ] ]#`
   */
...
export interface StandardLonghandPropertiesHyphen<TLength = (string & {}) | 0, TTime = string & {}> {
   ...
   * **Initial value**: `alpha`
   */
  "ma***REMOVED***border-mode"?: Property.MaskBorderMode | undefined;
  /**
   * The **`ma***REMOVED***border-outset`** CSS property specifies the distance by which an element's mask border is set out from its border box.
   *
   * **Syntax**: `[ <length> | <number> ]{1,4}`
   ...
   * @see https://developer.mozilla.org/docs/Web/CSS/ma***REMOVED***border-outset
   */
  "ma***REMOVED***border-outset"?: Property.MaskBorderOutset<TLength> | undefined;
  /**
   * The **`ma***REMOVED***border-repeat`** CSS property sets how the edge regions of a source image are adjusted to fit the dimensions of an element's mask border.
   *
   * **Syntax**: `[ stretch | repeat | round | space ]{1,2}`
   ...
   * @see https://developer.mozilla.org/docs/Web/CSS/ma***REMOVED***border-repeat
   */
  "ma***REMOVED***border-repeat"?: Property.MaskBorderRepeat | undefined;
  /**
   * The **`ma***REMOVED***border-slice`** CSS property divides the image set by `ma***REMOVED***border-source` into regions. These regions are used to form the components of an element's mask border.
   *
   * **Syntax**: `<number-percentage>{1,4} fill?`
   ...
   * @see https://developer.mozilla.org/docs/Web/CSS/ma***REMOVED***border-slice
   */
  "ma***REMOVED***border-slice"?: Property.MaskBorderSlice | undefined;
  /**
   * The **`ma***REMOVED***border-source`** CSS property sets the source image used to create an element's mask border.
   *
   * **Syntax**: `none | <image>`
   ...
   * @see https://developer.mozilla.org/docs/Web/CSS/ma***REMOVED***border-source
   */
  "ma***REMOVED***border-source"?: Property.MaskBorderSource | undefined;
  /**
   * The **`ma***REMOVED***border-width`** CSS property sets the width of an element's mask border.
   *
   * **Syntax**: `[ <length-percentage> | <number> | auto ]{1,4}`
   ...
   * @see https://developer.mozilla.org/docs/Web/CSS/ma***REMOVED***border-width
   */
  "ma***REMOVED***border-width"?: Property.MaskBorderWidth<TLength> | undefined;
  /**
   * The **`ma***REMOVED***clip`** CSS property determines the area which is affected by a mask. The painted content of an element must be restricted to this area.
   *
   * **Syntax**: `[ <geometry-box> | no-clip ]#`
   ...
   * @see https://developer.mozilla.org/docs/Web/CSS/ma***REMOVED***clip
   */
  "ma***REMOVED***clip"?: Property.MaskClip | undefined;
  /**
   * The **`ma***REMOVED***composite`** CSS property represents a compositing operation used on the current mask layer with the mask layers below it.
   *
   * **Syntax**: `<compositing-operator>#`
   ...
   * @see https://developer.mozilla.org/docs/Web/CSS/ma***REMOVED***composite
   */
  "ma***REMOVED***composite"?: Property.MaskComposite | undefined;
  /**
   * The **`ma***REMOVED***image`** CSS property sets the image that is used as mask layer for an element. By default this means the alpha channel of the mask image will be multiplied with the alpha channel of the element. This can be controlled with the `ma***REMOVED***mode` property.
   *
   * **Syntax**: `<ma***REMOVED***reference>#`
   ...
   * @see https://developer.mozilla.org/docs/Web/CSS/ma***REMOVED***image
   */
  "ma***REMOVED***image"?: Property.MaskImage | undefined;
  /**
   * The **`ma***REMOVED***mode`** CSS property sets whether the mask reference defined by `ma***REMOVED***image` is treated as a luminance or alpha mask.
   *
   * **Syntax**: `<masking-mode>#`
   ...
   * @see https://developer.mozilla.org/docs/Web/CSS/ma***REMOVED***mode
   */
  "ma***REMOVED***mode"?: Property.MaskMode | undefined;
  /**
   * The **`ma***REMOVED***origin`** CSS property sets the origin of a mask.
   *
   * **Syntax**: `<geometry-box>#`
   ...
   * @see https://developer.mozilla.org/docs/Web/CSS/ma***REMOVED***origin
   */
  "ma***REMOVED***origin"?: Property.MaskOrigin | undefined;
  /**
   * The **`ma***REMOVED***position`** CSS property sets the initial position, relative to the mask position layer set by `ma***REMOVED***origin`, for each defined mask image.
   *
   * **Syntax**: `<position>#`
   ...
   * @see https://developer.mozilla.org/docs/Web/CSS/ma***REMOVED***position
   */
  "ma***REMOVED***position"?: Property.MaskPosition<TLength> | undefined;
  /**
   * The **`ma***REMOVED***repeat`** CSS property sets how mask images are repeated. A mask image can be repeated along the horizontal axis, the vertical axis, both axes, or not repeated at all.
   *
   * **Syntax**: `<repeat-style>#`
   ...
   * @see https://developer.mozilla.org/docs/Web/CSS/ma***REMOVED***repeat
   */
  "ma***REMOVED***repeat"?: Property.MaskRepeat | undefined;
  /**
   * The **`ma***REMOVED***size`** CSS property specifies the sizes of the mask images. The size of the image can be fully or partially constrained in order to preserve its intrinsic ratio.
   *
   * **Syntax**: `<bg-size>#`
   ...
   * @see https://developer.mozilla.org/docs/Web/CSS/ma***REMOVED***size
   */
  "ma***REMOVED***size"?: Property.MaskSize<TLength> | undefined;
  /**
   * The **`ma***REMOVED***type`** CSS property sets whether an SVG `<mask>` element is used as a _luminance_ or an _alpha_ mask. It applies to the `<mask>` element itself.
   *
   * **Syntax**: `luminance | alpha`
   ...
   * @see https://developer.mozilla.org/docs/Web/CSS/ma***REMOVED***type
   */
  "ma***REMOVED***type"?: Property.MaskType | undefined;
  /**
   * This feature is not Baseline because it does not work in some of the most widely-used browsers.
   *
   * **Syntax**: `[ pack | next ] || [ definite-first | ordered ]`
...
export interface StandardShorthandPropertiesHyphen<TLength = (string & {}) | 0, TTime = string & {}> {
   ...
   * @see https://developer.mozilla.org/docs/Web/CSS/ma***REMOVED***border
   */
  "ma***REMOVED***border"?: Property.MaskBorder | undefined;
  /**
   * The **`offset`** CSS shorthand property sets all the properties required for animating an element along a defined path.
   *
   * **Syntax**: `[ <'offset-position'>? [ <'offset-path'> [ <'offset-distance'> || <'offset-rotate'> ]? ]? ]! [ / <'offset-anchor'> ]?`
...
export interface VendorLonghandPropertiesHyphen<TLength = (string & {}) | 0, TTime = string & {}> {
   ...
   * **Initial value**: `scroll`
   */
  "-webkit-ma***REMOVED***attachment"?: Property.WebkitMaskAttachment | undefined;
  /**
   * The **`ma***REMOVED***border-outset`** CSS property specifies the distance by which an element's mask border is set out from its border box.
   *
   * **Syntax**: `[ <length> | <number> ]{1,4}`
   ...
   * **Initial value**: `0`
   */
  "-webkit-ma***REMOVED***box-image-outset"?: Property.MaskBorderOutset<TLength> | undefined;
  /**
   * The **`ma***REMOVED***border-repeat`** CSS property sets how the edge regions of a source image are adjusted to fit the dimensions of an element's mask border.
   *
   * **Syntax**: `[ stretch | repeat | round | space ]{1,2}`
   ...
   * **Initial value**: `stretch`
   */
  "-webkit-ma***REMOVED***box-image-repeat"?: Property.MaskBorderRepeat | undefined;
  /**
   * The **`ma***REMOVED***border-slice`** CSS property divides the image set by `ma***REMOVED***border-source` into regions. These regions are used to form the components of an element's mask border.
   *
   * **Syntax**: `<number-percentage>{1,4} fill?`
   ...
   * **Initial value**: `0`
   */
  "-webkit-ma***REMOVED***box-image-slice"?: Property.MaskBorderSlice | undefined;
  /**
   * The **`ma***REMOVED***border-source`** CSS property sets the source image used to create an element's mask border.
   *
   * **Syntax**: `none | <image>`
   ...
   * **Initial value**: `none`
   */
  "-webkit-ma***REMOVED***box-image-source"?: Property.MaskBorderSource | undefined;
  /**
   * The **`ma***REMOVED***border-width`** CSS property sets the width of an element's mask border.
   *
   * **Syntax**: `[ <length-percentage> | <number> | auto ]{1,4}`
   ...
   * **Initial value**: `auto`
   */
  "-webkit-ma***REMOVED***box-image-width"?: Property.MaskBorderWidth<TLength> | undefined;
  /**
   * The **`ma***REMOVED***clip`** CSS property determines the area which is affected by a mask. The painted content of an element must be restricted to this area.
   *
   * **Syntax**: `[ <box> | border | padding | content | text ]#`
   ...
   * **Initial value**: `border`
   */
  "-webkit-ma***REMOVED***clip"?: Property.WebkitMaskClip | undefined;
  /**
   * The **`-webkit-ma***REMOVED***composite`** property specifies the manner in which multiple mask images applied to the same element are composited with one another. Mask images are composited in the opposite order that they are declared with the `-webkit-ma***REMOVED***image` property.
   *
   * **Syntax**: `<composite-style>#`
   ...
   * **Initial value**: `source-over`
   */
  "-webkit-ma***REMOVED***composite"?: Property.WebkitMaskComposite | undefined;
  /**
   * The **`ma***REMOVED***image`** CSS property sets the image that is used as mask layer for an element. By default this means the alpha channel of the mask image will be multiplied with the alpha channel of the element. This can be controlled with the `ma***REMOVED***mode` property.
   *
   * **Syntax**: `<ma***REMOVED***reference>#`
   ...
   * **Initial value**: `none`
   */
  "-webkit-ma***REMOVED***image"?: Property.WebkitMaskImage | undefined;
  /**
   * The **`ma***REMOVED***origin`** CSS property sets the origin of a mask.
   *
   * **Syntax**: `[ <box> | border | padding | content ]#`
   ...
   * **Initial value**: `padding`
   */
  "-webkit-ma***REMOVED***origin"?: Property.WebkitMaskOrigin | undefined;
  /**
   * The **`ma***REMOVED***position`** CSS property sets the initial position, relative to the mask position layer set by `ma***REMOVED***origin`, for each defined mask image.
   *
   * **Syntax**: `<position>#`
   ...
   * **Initial value**: `0% 0%`
   */
  "-webkit-ma***REMOVED***position"?: Property.WebkitMaskPosition<TLength> | undefined;
  /**
   * The `-webkit-ma***REMOVED***position-x` CSS property sets the initial horizontal position of a mask image.
   *
   * **Syntax**: `[ <length-percentage> | left | center | right ]#`
   ...
   * **Initial value**: `0%`
   */
  "-webkit-ma***REMOVED***position-x"?: Property.WebkitMaskPositionX<TLength> | undefined;
  /**
   * The `-webkit-ma***REMOVED***position-y` CSS property sets the initial vertical position of a mask image.
   *
   * **Syntax**: `[ <length-percentage> | top | center | bottom ]#`
   ...
   * **Initial value**: `0%`
   */
  "-webkit-ma***REMOVED***position-y"?: Property.WebkitMaskPositionY<TLength> | undefined;
  /**
   * The **`ma***REMOVED***repeat`** CSS property sets how mask images are repeated. A mask image can be repeated along the horizontal axis, the vertical axis, both axes, or not repeated at all.
   *
   * **Syntax**: `<repeat-style>#`
   ...
   * **Initial value**: `repeat`
   */
  "-webkit-ma***REMOVED***repeat"?: Property.WebkitMaskRepeat | undefined;
  /**
   * The `-webkit-ma***REMOVED***repeat-x` property specifies whether and how a mask image is repeated (tiled) horizontally.
   *
   * **Syntax**: `repeat | no-repeat | space | round`
   ...
   * **Initial value**: `repeat`
   */
  "-webkit-ma***REMOVED***repeat-x"?: Property.WebkitMaskRepeatX | undefined;
  /**
   * The `-webkit-ma***REMOVED***repeat-y` property sets whether and how a mask image is repeated (tiled) vertically.
   *
   * **Syntax**: `repeat | no-repeat | space | round`
   ...
   * **Initial value**: `repeat`
   */
  "-webkit-ma***REMOVED***repeat-y"?: Property.WebkitMaskRepeatY | undefined;
  /**
   * The **`ma***REMOVED***size`** CSS property specifies the sizes of the mask images. The size of the image can be fully or partially constrained in order to preserve its intrinsic ratio.
   *
   * **Syntax**: `<bg-size>#`
   ...
   * **Initial value**: `auto auto`
   */
  "-webkit-ma***REMOVED***size"?: Property.WebkitMaskSize<TLength> | undefined;
  /**
   * The **`max-inline-size`** CSS property defines the horizontal or vertical maximum size of an element's block, depending on its writing mode. It corresponds to either the `max-width` or the `max-height` property, depending on the value of `writing-mode`.
   *
   * **Syntax**: `<'max-width'>`
...
export interface VendorShorthandPropertiesHyphen<TLength = (string & {}) | 0, TTime = string & {}> {
   ...
   * **Syntax**: `<'ma***REMOVED***border-source'> || <'ma***REMOVED***border-slice'> [ / <'ma***REMOVED***border-width'>? [ / <'ma***REMOVED***border-outset'> ]? ]? || <'ma***REMOVED***border-repeat'> || <'ma***REMOVED***border-mode'>`
   */
  "-webkit-ma***REMOVED***box-image"?: Property.MaskBorder | undefined;
  /**
   * The **`text-emphasis`** CSS property applies emphasis marks to text (except spaces and control characters). It is a shorthand for `text-emphasis-style` and `text-emphasis-color`.
   *
   * **Syntax**: `<'text-emphasis-style'> || <'text-emphasis-color'>`
